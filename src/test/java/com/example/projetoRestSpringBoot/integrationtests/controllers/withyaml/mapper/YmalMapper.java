package com.example.projetoRestSpringBoot.integrationtests.controllers.withyaml.mapper;
...
public class YmalMapper implements ObjectMapper {

    private com.fasterxml.jackson.databind.ObjectMapper mapper;
    protected TypeFactory typeFactory;

    public YmalMapper() {
        mapper = new com.fasterxml.jackson.dataformat.yaml.YAMLMapper(new YAMLFactory())
